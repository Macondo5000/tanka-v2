...
import { ChevronDown, ArrowRight, Zap, CreditCard, LogOut } from 'lucide-react';
  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        className="flex items-center gap-1.5 px-1.5 py-1 rounded-lg hover:bg-black/[0.05] transition-colors"
      >
      ...
      {open && (
        <div className="absolute top-full right-0 mt-1.5 w-[300px] bg-white rounded-2xl border border-gray-100 shadow-2xl z-50 overflow-hidden">
          ...
          <div className="py-1.5">
            <button className="w-full flex items-center gap-3 px-5 py-2.5 text-left text-[13px] font-medium text-gray-600 hover:bg-[#f5f5f5] transition-colors">
