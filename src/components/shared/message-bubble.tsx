  ...
  if (role === 'user') {
    return (
      <div className="w-full flex flex-col items-end gap-1">
        {timestamp && <span className="text-[11px] text-gray-400 px-1">{timestamp}</span>}
        <div className="max-w-[75%] w-fit px-4 py-2.5 rounded-2xl text-[15px] leading-relaxed font-normal bg-[#D7F5FE] text-black rounded-tr-none">
          {content}
        </div>
      </div>
    );
      ...
      <div className="flex items-start gap-2.5">
        ...
        <div className="flex flex-col gap-1">
          <div className="flex items-center gap-2 px-1">
            {sender && <span className="text-[14px] text-gray-500 font-medium">{sender.name}</span>}
            {timestamp && <span className="text-[12px] text-gray-400">{timestamp}</span>}
          </div>
          <div className="max-w-[75%] w-fit px-4 py-2.5 rounded-2xl rounded-tl-none bg-[#F8F8F7] text-[15px] leading-relaxed font-normal text-[#3C3C3C]">
            {content}
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-col items-start gap-1 w-full max-w-[480px]">
        ...
        <div className="bg-purple-50/50 border border-purple-100/50 rounded-xl px-4 py-4 w-full">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-[11px] font-semibold text-purple-600 uppercase tracking-widest">AI initiated</span>
          </div>
          <div className="text-[15px] leading-[1.6] font-normal text-purple-900/80 tracking-tight">
            {content}
          </div>
        </div>
      </div>
  ...
  return (
    <div className="flex flex-col items-start gap-1 max-w-[85%]">
      ...
      <div className="px-0.5 py-1">
        <div className="text-[15px] leading-[1.6] font-normal text-[#3C3C3C] tracking-tight">
          {content}
        </div>
      </div>
    </div>
