      ...
      <div className="px-2 py-2 space-y-0.5">
        <button
          ...
          className={`w-full flex items-center gap-2.5 px-2.5 py-2 rounded-lg text-left transition-all border ${
            linkFilter === 'linked' ? 'bg-[#DDE9F6] border-transparent text-black' : 'border-transparent text-gray-800 hover:bg-[#E8F0FA]'
          }`}
        >
        ...
        <button
          ...
          className={`w-full flex items-center gap-2.5 px-2.5 py-2 rounded-lg text-left transition-all border ${
            linkFilter === 'unlinked' ? 'bg-[#DDE9F6] border-transparent text-black' : 'border-transparent text-gray-800 hover:bg-[#E8F0FA]'
          }`}
        >
